...
void NewBlock(memory **head, int i)
{
...
memory *First_fit(memory *head, int data)
{
...
memory *nextFit(memory *head, int data)
{
...
memory *best_fit(memory *head, int data)
{
...
memory *worst_fit(memory *head, int data)
{
...
int main()
{
    ...
    NewBlock(&node, 8);
    printResult(node);
    temp = First_fit(node, 14);
    printResult(node);
    nextFit(node, 10);
    printResult(node);
    temp = First_fit(node, 7);
    printResult(node);
